...
print("Independent class EmployeeClass1:")
print("-"*20)
# ---------------
...
print("Independent class EmployeeClass2:")
print("-"*20)
# ---------------
...
print("Independent class EmployeeClass3")
print("-"*20)
# ---------------
...
print("Main Class Extending from multiple classes:")
print("-"*20)
# ---------------
# Multiple Inheritance
class MainClass(EmployeeClass1, EmployeeClass2, EmployeeClass3):
...
MainClass.store_company_details("XYZ Company", "XYZ Location")
# Internally, object 'Employee' will get passed to 1st argument 'cls'

company_details = MainClass.get_company_details()
# Internally, object 'Employee' will get passed to 1st argument 'cls'
...
MainClass.write_to_json("company_data.json")
# Internally object 'Employee' will be passed to 'cls'
print("company_data.json created. Please check")

company_details = MainClass.read_from_json("company_data.json")
print("company_details:", company_details, end="\n\n")
